  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0">
      {butterflies.map((butterfly) => (
          ...
          animate={{
            ...
            x:
              butterfly.direction > 0
                ? [0, window.innerWidth * 0.3, window.innerWidth * 0.6, window.innerWidth]
                : [0, -window.innerWidth * 0.3, -window.innerWidth * 0.6, -window.innerWidth],
            y: [
              butterfly.style.top,
        ...
        >
          <ButterflyShape color={butterfly.color} direction={butterfly.direction} />
        </motion.div>
      ))}
    </div>
  )
...
function ButterflyShape({ color, direction }: { color: string; direction: 1 | -1 }) {
  return (
