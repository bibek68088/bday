...
export default function FinalCelebration({ name = "Aakrity", from = "Bibek" }) {
  ...
  const memories = [
    ...
    { title: "Movie Date", description: "Our cozy movie nights and days with some drinks and foods also pizza.🍕" },
    { title: "Surprise Valentine", description: "When I surprised you in valentine at my place.🫂" },
    { title: "Walking Together", description: "Hand in hand, heart to heart.😍" },
    { title: "Staring Each Other", description: "My Heart stops when you look at me.🤭" },
  ]
  ...
  useEffect(() => {
    // Automatically open the card after a delay
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-gradient-to-b from-purple-100 to-pink-200 py-8 px-4 md:py-12 relative overflow-x-hidden overflow-y-auto"
    >
      {/* Background audio */}
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        <div className="flex justify-center font-handwriting font-medium mb-8 gap-1 sm:gap-2 flex-wrap sticky top-4 z-30 py-2 px-2 sm:px-4 backdrop-blur-md bg-white/30 rounded-full shadow-lg">
          {["wishes", "gallery", "memories", "message", "gift", "forever"].map((tab) => (
            <motion.button
              ...
              className={`px-3 py-2 sm:px-6 sm:py-3 rounded-full text-sm sm:text-lg font-medium transition-all ${
                activeTab === tab
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-4 sm:p-8 md:p-12 overflow-hidden"
          >
            {activeTab === "wishes" && (
              <div ref={wishesRef}>
                <motion.h2
                ...
                <div className="mt-8 text-center">
                  ...
                  >
                    {/* <button
                      ...
                      className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-6 py-3 rounded-full flex items-center"
                    >
        ...
        >
          <button
            ...
            className="bg-gradient-to-r from-fuchsia-500 to-pink-600 hover:from-fuchsia-600 hover:to-pink-700 text-white px-10 py-6 text-xl rounded-full shadow-lg shadow-pink-500/30"
          >
            Celebrate Again!
            <PartyPopper className="ml-2 h-6 w-6 inline" />
          </button>
        </motion.div>
      </div>
