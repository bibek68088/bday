...
import photo9 from "../images/img9.jpg"
import photo10 from "../images/img10.jpg"
import photo11 from "../images/img11.jpg"
import photo12 from "../images/img12.jpg"
  ...
  const PhotoFrame = ({ photo }: { photo: Photo }) => {
    ...
    const getFrameStyle = () => {
      switch (photo.frameStyle) {
        case 0: // Simple frame
          return (
            <div className={`p-4 bg-gradient-to-br ${photo.frameColor} rounded-sm shadow-lg`}>
      ...
      {photos.map((photo) => (
        <motion.div
          ...
          style={{
            ...
            width: `${photo.width / photo.scaleFactor}px`,
            height: `${photo.height / photo.scaleFactor}px`,
